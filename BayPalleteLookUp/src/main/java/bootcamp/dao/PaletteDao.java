...
public class PaletteDao {
	...
	private final String ADD_PALETTE= "INSERT INTO palette (id, dep) VALUES (?, ?);";
	private final String GET_PALETTE_BY_ID = "SELECT * FROM palette WHERE id = ?;";
	private final String EDIT_PALETTE = "UPDATE palette SET bay=?,width=? WHERE id = ?;";
	...
	public void addPalette(Palette palette) {
		Object[] args = {palette.getId(), palette.getDep()};
	...
	public void editPalette(Palette palette) {
		Object[] args = {palette.getBayId(), palette.getWidth(), palette.getId()};
